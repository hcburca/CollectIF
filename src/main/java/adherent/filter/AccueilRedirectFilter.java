...
/**
 * The <code>AccueilRedirectFilter</code> class is used to redirect users from the filtered resources
 * to the home page if a user session exists.
 * @author  Burca Horia
 * @version 1.0
 * @since   2017-04-17
 */
@WebFilter(filterName = "AccueilRedirectFilter", urlPatterns = {"/", "/index.html"})
public class AccueilRedirectFilter implements Filter {
     ...
     * session and a "user", if it's the case it responds with a redirection to the home page,
     * otherwise it sends the request to the <code>FilterChain</code>.
